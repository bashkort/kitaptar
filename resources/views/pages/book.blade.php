        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <img class="img-thumbnail img-responsive pull-left book-cover"  src="/storage/{{  $book->cover }}"  onerror="this.src='http://kitaptar.bashkort.org/template/default_cover.png'">
			...
			<tbody>
		      ...
		      @endforeach
                    ...
                    <form id="merge" role="form" action="#" method="get" enctype="multipart/form-data" class="form-horizontal" onsubmit="this.action='/mergeBooks/{{ $book->id }}/' + $('#id').val()">
                      <div class="form-group{{ $errors->has('id') ? ' has-error' : '' }}">
                          <label for="name" class="col-md-4 control-label">ID зависимой книги для слияния</label>
