          ...
          <div class="panel-body">
            <form role="form" action="add_book" method="post" enctype="multipart/form-data" class="form-horizontal" >
              ...
              <div class="form-group{{ $errors->has('authors') ? ' has-error' : '' }}">
                  <label for="authors" class="col-md-4 control-label">Имена авторов, каждое в новом поле</label>

                  <div class="col-md-6" id="authors_div">
                      <input id="authors" type="text" class="form-control" name="authors[]" required oninput="$('#authors_div').append($('#authors_pattern').html()); this.oninput=''">
              ...
              <div class="form-group{{ $errors->has('book_files') ? ' has-error' : '' }}">
                  ...
                  <div class="col-md-6" id="inputs">
                      <div class="input-group">
                        <input type="file" name="book_files[]" class="book_files" accept=".fb2,.epub,.txt,.doc,.docx,.pdf,.djvu" required onchange="$('#inputs').append($('#pattern').html()); this.onchange=''"><br />
                      </div>
